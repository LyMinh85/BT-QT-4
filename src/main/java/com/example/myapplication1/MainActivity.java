...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Chanels chanels1 = new Chanels("GooglePlus", "+whitehouse");
        Chanels chanels2 = new Chanels("Facebook", "whitehouse");
        Chanels chanels3 = new Chanels("Twitter", "+whitehouse");
        Chanels chanels4 = new Chanels("YouTube", "+whitehouse");
        ...
        txt2.setText(officials.getPosision() + System.getProperty("line.separator") +officials.getName() + System.getProperty("line.separator")+ officials.getParty());
        ...
        facebookButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.facebook.com/"+chanels2.getId()));
        ...
        googleButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://plus.google.com/"+chanels1.getId()));
                startActivity(browserIntent);
            }
        });
        ...
        twitterButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/"+chanels3.getId()));
                startActivity(browserIntent);
            }
        });
        ...
        youtubeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/"+chanels4.getId()));
                startActivity(browserIntent);
            }
        });
